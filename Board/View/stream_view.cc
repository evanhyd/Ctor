...
// Format Vertex
string StreamView::FV(int vertex, Layout& layout) {
...
// Format Edge
string StreamView::FE(int edge, Layout& layout) {
...
// Format Robber
string StreamView::FR(int tile, Layout& layout) {
...
//Format Tile Name
string StreamView::FTN(int index, Layout& layout) {
  const std::unique_ptr<Tile>& tile = layout.GetTiles()[index];
  return tile->GetTileType();
}

//Format Tile Number
string StreamView::FTNum(int index, Layout& layout) {
  const std::unique_ptr<Tile>& tile = layout.GetTiles()[index];
  return to_string(tile->GetNumber());
}


void StreamView::RenderImpl(Layout& l){
  string display = "";
  display += Format("                    |%2v|--%2v--|%2v|\n", FV(0, l), FE(0, l), FV(1, l));
  display += Format("                      |         |\n");
  display += Format("                     %2v    0   %2v\n", FV(1, l),  FV(2, l));
  display += Format("                      | %7v |\n", FTN(0, l));
  display += Format("          |%2v|--%2v--|%2v|  %2v  |%2v|--%2v--|%2v|\n", FV(2, l), FE(3, l), FV(3, l), FTNum(0, l), FV(4, l), FE(4, l), FV(5, l));
  display += Format("            |         |  %5v  |         |\n", FR(0, l));
  display += Format("           %2v    1   %2v        %2v    2   %2v\n", FE(5, l), FE(6, l), FE(7, l), FE(8, l));
  display += Format("            | %7v |         | %7v |\n", FTN(1, l), FTN(2, l));
  display += Format("|%2v|--%2v--|%2v|  %2v  |%2v|--%2v--|%2v|  %2v  |%2v|--%2v--|%2v|\n", FV(6, l), FE(9, l), FV(7, l), FTNum(1, l), FV(8, l), FE(10, l), FV(9, l), FTNum(2, l), FV(10, l), FE(11, l), FV(11, l));
  display += Format("  |         |  %5v  |         |  %5v  |         |\n", FR(1, l), FR(2, l));
  display += Format(" %2v   %2v   %2v        %2v   %2v   %2v        %2v   %2v   %2v\n", FE(12, l), FE(13, l), FE(14, l), FE(15, l), FE(16, l), FE(17, l));
  display += Format("  | %7v |         | %7v |         | %7v |\n", FTN(3, l), FTN(4, l), FTN(5, l));
  display += Format("|12|   4  |13|--18--|14|      |15|--19--|16|  10  |17|\n", FV(12, l), FTNum(4, l), FV(13, l), FE(18, l), FV(14, l), FV(15, l), FE(19, l), FV(16, l), FTNum(5, l), FV(17, l));
  display += Format("  |  %5v  |         |  %5v  |         |  %5v  |\n", FR(3, l), FR(4, l), FR(5, l));
  display += Format(" %2v        %2v    6   %2v        %2v    7   %2v        %2v\n", FE(20, l), FE(21, l), FE(22, l), FE(23, l), FE(24, l), FE(25, l));
  display += Format("  |         | %7v |         | %7v |         |\n", FTN(6, l), FTN(7, l));
  display += Format("|%2v|--%2v--|%2v|  %2v  |%2v|--%2v--|%2v|  %2v  |%2v|--%2v--|%2v|\n", FV(18, l), FE(26, l), FV(19, l), FTNum(6, l), FV(20, l), FE(27, l), FV(21, l), FTNum(7, l), FV(22, l), FE(28, l), FV(23, l));
  display += Format("  |         |  %5v  |         |  %5v  |         |\n", FR(6, l), FR(7, l));
  display += Format(" %2v    8   %2v        %2v    9   %2v        %2v   10   %2v\n", FE(29, l), FE(30, l), FE(31, l), FE(32, l), FE(33, l), FE(34, l));
